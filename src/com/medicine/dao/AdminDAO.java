...
public class AdminDAO {
	...
	public List<Admin> findByExample(Admin instance) {
		...
		try {
			List<Admin> results = (List<Admin>) getCurrentSession()
					.createCriteria("com.medicine.entity.Admin")
	...
	public List<Admin> findByTel(Object tel) {
...
/*************************************************************/
	public Admin getAdminByLoginname(String loginname) {
		...
		String hql = "from Admin a where a.loginname=:loginname";
		Query query = getCurrentSession().createQuery(hql).setString("loginname", loginname);
		return (Admin) (query.list().isEmpty()?null:query.list().get(0));
	}
}