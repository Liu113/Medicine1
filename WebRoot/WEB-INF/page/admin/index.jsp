...
<html>
                    ...
                    <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                         ...
                         <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class=""> 
                                    <dd class="">
                                        <a _href="${pageContext.request.contextPath}/admin/manager/medicine/queryList">
                                            <cite>药品查询</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            <a class="javascript:;" href="javascript:;">
                                <i class="layui-icon" style="top: 3px;">&#xe630;</i><cite>店员管理</cite>
                            </a>
                            <dl class="layui-nav-child">
                                <dd class="">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class=""> 
                                    <dd class="">
                                        <a _href="${pageContext.request.contextPath}/admin/manager/admin/in/queryList">
                                            <cite>入库单查询</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class=""> 
                                    <dd class="">
                                        <a _href="${pageContext.request.contextPath}/admin//manager/admin/sale/queryList">
                                            <cite>销售单查询</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="${pageContext.request.contextPath}/admin/manager/admin/pwd/updateVo">
                                        <cite>密码修改</cite>
                                    </a>
                                </dd>
                            </dl>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;"  _href="${pageContext.request.contextPath}/admin/manager/admin/person/queryVo">
                                        <cite>个人信息</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" onclick="quit()" _href="${pageContext.request.contextPath}/admin/manager/admin/person/queryVo">
                                        <cite>退出系统</cite>
                                    </a>
                                </dd>
                            </dl>
            ...
            <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab" lay-allowclose="true">
                ...
                <div class="layui-tab-content site-demo site-demo-body">
                    <div class="layui-tab-item layui-show">
                        <iframe frameborder="0" src="${pageContext.request.contextPath}/admin/manager/welcome" class="x-iframe"></iframe>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function quit(){
        	$.post("${pageContext.request.contextPath}/admin/logout","",function(res){
        		if(res.mes=="1"){
