            ...
            <form id="asd" class="layui-form" action="" method="post">
                <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="roleCode" id="roleCode" required="" lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" id="roledesc" class="layui-input">
                    </div>
                </div>
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(add)', function(data){
            	  $.post("${pageContext.request.contextPath}/admin/manager/role/roleAdd",$("#asd").serialize(),function(res){
            	  	alert(res.mes);
            		  if(res.mes=="1"){
