            ...
            <form id="asd" class="layui-form" action="" method="post">
                    ...
                    <div class="layui-input-inline" style="width: 50%">
                      <select name="class_">
                        ...
                        <c:forEach items="${classList}" var="classs">
                        	<option <c:if test="${medicine.class_ == classs.class_}">selected="selected"</c:if> value="${classs.class_}">${classs.className}</option>
                        </c:forEach>
                      </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" id="mimg" class="layui-input">
                 </div>
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(edit)', function(data){
            	  $.post("${pageContext.request.contextPath}/admin/manager/medicine/medicineUpdate",$('#asd').serialize(),function(res){
            		  if(res.mes=="1"){
