...
<html lang="en" class="no-js">
    ...
    *background-color:transparent;
    ...
    <body background-image="../resources/bgImg.jpg">

        <div class="page-container">
            <h1 ><font color="black">Login(店员版)</font></h1>
    	...
    	<script type="text/javascript">
    		function login(){
    			...
    			$.post("${pageContext.request.contextPath}/user/manager/login",
    					"loginname="+$("#loginname").val()
    					+"&password="+$("#password").val(),
			function(o){
  				if(o.code == 1){
  					location.href="${pageContext.request.contextPath}/user/manager/index";
  				}else{
  					$("#ts").html("登录失败");
  					//使提示框显示出来
  					is_show();
