                ...
                <div class="layui-form-item">
                   <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="text" name="username" disabled="disabled" value="${user.username}"  lay-verify="required"  autocomplete="off" class="layui-input">
				    </div>
				  </div>
                </div>
	...
	<script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(updatPassword)', function(data){
            	  $.post("${pageContext.request.contextPath}/user/manager/user/pwd/update","userPassword="+$("#userPassword").val(),function(res){
            		  if(res.mes=="1"){
