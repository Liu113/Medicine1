        ...
        <div class="x-body">
            <form id="asd" class="layui-form" action="" method="post">
                ...
                <div class="layui-form-item">
                 ...
                 <div class="layui-form-item">
                    <label  class="layui-form-label">
                        <span class="x-red">*</span>药品增加数量
                    </label>
                    <div class="layui-input-inline">
                        <input type="text"   name="addNum"  required="" 
        ...
        <script>
            layui.use(['form','layer'], function(){
              ...
              form.on('submit(edit)', function(data){
            	  $.post("${pageContext.request.contextPath}/user/manager/user/addNum",$('#asd').serialize(),function(res){
            		  if(res.mes=="1"){
            			  layer.alert('入库单申请成功', {icon: 6},function(){
            			  ...
            			  layer.alert('入库单申请失败', {icon: 2},function(){
            				  var index = parent.layer.getFrameIndex(window.name); //先得到当前iframe层的索引
                			  parent.layer.close(index); //再执行关闭      
                			  //刷新父页面
                			  window.parent.location.reload();
