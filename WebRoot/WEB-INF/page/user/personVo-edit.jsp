...
<html>
    ...
    <body>
            ...
            <input type="hidden" name="id" value="${user.id}">
                ...
                <div class="layui-form-item">
                 ...
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="email" name="email"  lay-verify="required" value="${user.email}"
                ...
                <%-- <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 50%">
                      <select name="role" lay-verify="required" disabled="disabled">
                        <c:forEach items="${roleList}" var="role">
                        	<option value="${role.id}" <c:if test="${user.role==role.id}">selected</c:if> >${role.rolename}</option>
                        </c:forEach>
                      </select>
                 ...
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                       <textarea rows="7" cols="60"  name="address"  required>${user.address}</textarea>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            function updatePer(){
        		$.post("${pageContext.request.contextPath}/user/manager/user/person/update",$('#asd').serialize(),function(res){
        			alert(res.code)
        			if(res.code == "1" ){
        				alert("更新成功");
